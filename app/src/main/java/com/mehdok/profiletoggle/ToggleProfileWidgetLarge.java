 ...
 */
public class ToggleProfileWidgetLarge extends AppWidgetProvider
{
    public static final String CHANGE_PROFILE = "com.mehdok.profiletoggle.CHANGE_PROFILE";
    private static int currentState = 0;
    public static final String TAG = "profile_changer_large";
    ...
    {
        //Log.e(TAG, "buildButtonPendingIntent");
        ComponentName myWidgetLarge = new ComponentName(context, ToggleProfileWidgetLarge.class);
        AppWidgetManager manager = AppWidgetManager.getInstance(context);
        manager.updateAppWidget(myWidgetLarge, remoteViews);
    }
